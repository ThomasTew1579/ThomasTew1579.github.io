...
<template>
    <section class="dropdown-youtube h-[750px] opacity-0 py-4 bg-black/75">
        <div class="dropdown container px-4 mx-auto max-w-[1680px] flex flex-row justify-between gap-4 h-full  text-white">
            <a v-for="(item, index) in items" :key="index" :href="item.link" target="_blank" class="video rounded-md duration-500 h-full overflow-clip w-24 grow-0 relative">
                ...
                <div class="title-close absolute bottom-0 left-0">
