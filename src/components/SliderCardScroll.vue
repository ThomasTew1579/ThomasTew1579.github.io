...
<section class="slider-realisations flex flex-col gap-10 lg:mt-20 py-8 md:py-16 fade-in">
            ...
            <div class="container">
                <div class="outro flex justify-center">
                    <ButtonSecondary link="/realisations/" title="Voir tout" class="btn-primary group w-fit py-[10px] px-[19px] font-semibold text-base rounded-full relative overflow-hidden select-none touch-manipulation transition-all duration-300 inline-flex items-center gap-2.5 outline outline-primary-900 outline-0 hover:outline-1">
                        <span class="content">
                            Voir tout
                        </span>
                        <span class="icon  size-[30px] p-[7px] overflow-hidden rounded-full duration-300">
                            <svg viewBox="0 0 40 16" class="h-4 w-10 fill-current transition-all duration-300 translate-x-[-1.5rem] group-hover:translate-x-0">
                                <use xlink:href="/src/assets/sprite/far.svg#arrow-right" width="16" />
                                <use xlink:href="/src/assets/sprite/far.svg#arrow-right" width="16" x="24" />
                            </svg>
                        </span>
                    </ButtonSecondary>
                </div>
