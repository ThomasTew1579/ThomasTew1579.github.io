...
<template>
  <HeroImage title="Formations" image="/src/assets/image/illustrations/illu-form.webp" />

  <Damier title="Développeur Full Stack chez Pilot’in" :order = "true" image="/src/assets/image/photo-perso.jpg" >
